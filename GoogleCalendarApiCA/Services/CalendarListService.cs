...
namespace GoogleCalendarApi.Services
{
	public class CalendarListService
	{
		...
		{
			ListRequest listRequest = _calendarService.CalendarList.List();
		...
		{
			CalendarListResource.InsertRequest insertRequest = _calendarService.CalendarList.Insert(calendar);
